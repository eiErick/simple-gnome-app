...
export const PomodoroApplication = GObject.registerClass(
    class PomodoroApplication extends Adw.Application {
        constructor() {
            super({application_id: 'io.github.eierick.pomodoro', flags: Gio.ApplicationFlags.DEFAULT_FLAGS});
            ...
            show_about_action.connect('activate', action => {
                let aboutParams = {
                    ...
                    application_icon: 'io.github.eierick.pomodoro',
                    developer_name: 'Érick',
                    version: '0.1.0',
                    developers: [
                        'Érick'
                    ],
